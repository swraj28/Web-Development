...
// class is a syntactical sugar overy prototype in javascript.

// There is no concept of access modifier in javascript. Everything is made public 
...
class Student extends Person {
  constructor(name, age, grade) {
    super(name, age)  // Run the constructor of Person first . 
    this.grade = grade
  }
}
